...
# torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=cosmos_predict2/configs/base/config.py -- experiment=predict2_video2world_training_2b_metropolis model.config.train_architecture=lora 
predict2_v2w_2b_rank16_loraqkv_only_lr210_combined_1000_1000 = dict(
    defaults=[
    ...
    job=dict(
        ...
        group="video2world",
        name="predict2_v2w_2b_rank16_loraqkv_only_lr210_combined_1000_1000",
    ),
    model=dict(
        config=dict(
            pipe_config=dict(
...
for _item in [
    # 2b, metropolis
    predict2_v2w_2b_rank16_loraqkv_only_lr210_combined_1000_1000,
]:
