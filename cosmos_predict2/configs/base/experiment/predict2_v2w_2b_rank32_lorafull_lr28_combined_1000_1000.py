...
example_video_dataset_metropolis = L(Dataset)(
    dataset_dir="dataset/metropolis/train/v3/combined_1000_1000/",
    num_frames=93,  # Standard frame count, will be cropped/padded as needed
    video_size=(704, 1280),  # Height, Width format - matches your 1280x740 videos
)
...
# torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=cosmos_predict2/configs/base/config.py -- experiment=predict2_v2w_2b_rank32_lorafull_lr28_combined_1000_1000 model.config.train_architecture=lora
predict2_v2w_2b_rank32_lorafull_lr28_combined_1000_1000 = dict(
    defaults=[
    ...
    job=dict(
        ...
        group="video2world",
        name="predict2_v2w_2b_rank32_lorafull_lr28_combined_1000_1000",
    ),
    model=dict(
        config=dict(
            pipe_config=dict(
...
for _item in [
    # 2b, metropolis
    predict2_v2w_2b_rank32_lorafull_lr28_combined_1000_1000,
]:
