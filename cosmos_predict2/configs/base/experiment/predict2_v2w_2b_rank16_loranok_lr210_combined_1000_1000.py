...
# torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=cosmos_predict2/configs/base/config.py -- experiment=predict2_v2w_2b_rank16_loranok_lr210_combined_1000_1000
predict2_v2w_2b_rank16_loranok_lr210_combined_1000_1000 = dict(
    defaults=[
    ...
    job=dict(
        ...
        group="video2world",
        name="predict2_v2w_2b_rank16_loranok_lr210_combined_1000_1000",
    ),
    model=dict(
        config=dict(
            pipe_config=dict(
            ...
            lora_rank=16,
            lora_alpha=16,
            lora_target_modules="q_proj,v_proj,output_proj,mlp.layer1,mlp.layer2",
        )
    ),
    model_parallel=dict(
...
for _item in [
    # 2b, metropolis
    predict2_v2w_2b_rank16_loranok_lr210_combined_1000_1000,
]:
