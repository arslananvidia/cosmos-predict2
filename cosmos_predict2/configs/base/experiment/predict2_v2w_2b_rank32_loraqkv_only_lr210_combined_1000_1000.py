...
predict2_v2w_2b_rank32_loraqkv_only_lr210_combined_1000_1000 = dict(
    defaults=[
    ...
    job=dict(
        ...
        group="video2world",
        name="predict2_v2w_2b_rank32_loraqkv_only_lr210_combined_1000_1000",
    ),
    model=dict(
        config=dict(
            pipe_config=dict(
...
for _item in [
    # 2b, metropolis
    predict2_v2w_2b_rank32_loraqkv_only_lr210_combined_1000_1000,
]:
